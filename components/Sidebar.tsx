...
"use client";
import { BarChart3, ShieldAlert, Sun, Thermometer } from "lucide-react";
...
export default function Sidebar({ activeLayer, setActiveLayer }: SidebarProps) {
  return (
    <div className="absolute top-6 left-6 w-80 flex flex-col gap-6 z-10 pointer-events-auto">
      {/* Logo Area */}
      <div className="bg-[#141E1C]/70 backdrop-blur-xl border border-white/10 p-4 rounded-2xl shadow-2xl">
        <div className="flex items-center gap-3">
          <div className="p-2 bg-[#06D6A0] rounded-lg">
          ...
          <div>
            ...
            <p className="text-[#06D6A0] text-[10px] font-mono tracking-widest uppercase">
